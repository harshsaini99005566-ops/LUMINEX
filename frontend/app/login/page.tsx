        ...
        <div className="card-elevated shadow-lg border-none">
          ...
          <div className="mt-6 flex flex-col gap-3">
            ...
            <p className="text-xs text-center text-brand-muted mt-2">
              We need access to your Facebook pages to enable automation features
            </p>
          </div>
...
export default function LoginPage() {
  return (
    <Suspense fallback={<div className="min-h-screen bg-brand-light flex items-center justify-center">Loading...</div>}>
      <LoginContent />
    </Suspense>
  )
}
